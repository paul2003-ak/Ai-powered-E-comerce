        ...
        <div className='w-[100%] md:h-[36vh] h-[21vh]  mb-[77px] md:mb-[0px] '>
            <div className=' w-[100%] md:h-[30vh] h-[15vh] md:mb-[0px] bg-[#dbfcfcec] flex items-center justify-center md:px-[50px] px-[5px] '>
                <div className=' md:w-[30%] w-[35%] h-[100%] flex justify-center flex-col gap-[5px] '>
                    <div className=' flex items-start justify-start gap-[5px] mt-[10px] md:mt-[40px] '>
                        ...
                        <p className=' text-[19px] md:text-[20px] text-[black] '>AiOneCart</p>
                    </div>
                    ...
                    <p className=' text-[15px] text-[#1e2223] flex md:hidden '> Fast. Easy. Reliable. AiOneCart Shopping</p>
                ...
                <div className=' md:w-[25%] w-[30%] h-[100%] flex items-center justify-center flex-col text-center '>
                    ...
                    <ul>
                        ...
                        <li className=' text-[15px] text-[#1e2223] md:block cursor-pointer  '>Delivery</li>
                ...
                <div className='md:w-[25%] w-[40%] h-[100%] flex items-center justify-center flex-col text-center '>
                    ...
                    <ul>
                        <li className=' text-[15px] text-[#1e2223] cursor-pointer  '>+91-8670893850</li>
                        <li className=' text-[15px] text-[#1e2223] cursor-pointer  '>ayanpaulcse08@gmail.com</li>
                        <li className=' text-[15px] text-[#1e2223] md:block cursor-pointer  '>+1-123-456-7890</li>
                        <li className=' text-[15px] text-[#1e2223] cursor-pointer  '>admin@aionecart.com</li>
                    </ul>
            ...
            <div className=' w-[100%] h-[1px] bg-slate-400  '>
                <div className=' w-[100%] h-[5vh] bg-[#dbfcfcec] flex items-center justify-center '>
                        Copyright 2025@AiOneCart. Com-All Right Reserved
                </div>
            </div>
